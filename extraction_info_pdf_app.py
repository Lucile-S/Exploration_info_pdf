...
def folder_selector(dir):
    ...
    selected_dir_path = os.path.join(path, selected_dir)
...
def neo4j_selector(folder_path='.'):
...
def convert_and_save_to_json(df,AAV_df, save_dir): 
...
## output directory 
dir = os.getcwd()
save_dir = os.path.join(dir, 'extraction_info_pdf_output/')
